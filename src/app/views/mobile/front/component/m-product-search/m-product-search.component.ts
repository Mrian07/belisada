...
export class MProductSearchComponent implements OnInit {
  ...
  sortThis(ob) {
    ...
    if (this.Params.q) {
      ...
      this.router.navigate(['/mobile/m-search'], { queryParams: this.Params });
    }else {
      this.Params =  {
        parent : 3,
        id : this.catId,
      ...
      this.router.navigate(['/mobile/m-product-list'], { queryParams: this.Params });
    }
  }
  ...
  setPage(page: number, increment?: number) {
    ...
    this.router.navigate(['/mobile/m-search'], { queryParams: { page: page}, queryParamsHandling: 'merge' });
    window.scrollTo(0, 0);
  }
