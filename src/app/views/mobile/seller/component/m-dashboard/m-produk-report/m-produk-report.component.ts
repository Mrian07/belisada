...
@Component({
  selector: 'app-m-produk-report',
  templateUrl: './m-produk-report.component.html',
  styleUrls: ['./m-produk-report.component.scss']
})
export class MProdukReportComponent implements OnInit {
