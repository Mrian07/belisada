...
@Component({
  selector: 'app-m-search-dashboard',
  templateUrl: './m-search-dashboard.component.html',
  styleUrls: ['./m-search-dashboard.component.scss']
})
export class MSearchDashboardComponent implements OnInit {
