...
@Component({
  selector: 'app-m-profile-buyer',
  templateUrl: './m-profile-buyer.component.html',
  styles: [`/deep/ .ngx-datepicker-container .ngx-datepicker-input{ width: 100% !important; }`],
  styleUrls: ['./m-profile-buyer.component.scss']
})
export class MProfileBuyerComponent implements OnInit {
