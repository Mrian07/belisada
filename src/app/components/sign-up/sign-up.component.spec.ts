...
describe('SignUpComponent', () => {
  ...
  it('fullname validation', () => {
    let fullname = component.vForValidation.controls['fullname'];
  ...
  it('email validation', () => {
    let control = component.vForValidation.controls['email'];
  ...
  it('password validation', () => {
    let control = component.vForValidation.controls['password'];
    expect(control).toBeTruthy();
    control.setValue('');
    expect(control.valid).toBeFalsy();
